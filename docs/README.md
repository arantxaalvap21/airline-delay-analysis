...
Esta carpeta contiene documentación complementaria del proyecto **Airline Delay Analysis — Q1 2026**.
...
| `evidencias/` | Capturas de validación en DBeaver: schema, conteo de registros y consultas ejecutadas. |
